...
PARAM <- list()
#PARAM$experimento <- "FE631_014"
PARAM$experimento <- "FE631_014_MA"
...
if (PARAM$lag1) {
  ...
  for (vcol in cols_lagueables_monto)
  {
    ...
    dataset[, paste0(vcol, "_delta1_weight") := (get(vcol)*2 + get(paste0(vcol, "_lag1"))) / (get(vcol) + get(paste0(vcol, "_lag1")))] #Ratio asign�ndole m�s peso a la columna nueva
...
if (PARAM$lag2) {
  ...
  for (vcol in cols_lagueables_monto)
  {
    ...
    dataset[, paste0(vcol, "_delta2_weight") := (get(vcol)*2 + get(paste0(vcol, "_lag2"))) / (get(vcol) + get(paste0(vcol, "_lag2")))] #Ratio asign�ndole m�s peso a la columna nueva
  }
...
if (PARAM$lag3) {
  ...
  for (vcol in cols_lagueables_monto)
  {
    ...
    dataset[, paste0(vcol, "_delta3_weight") := (get(vcol)*2 + get(paste0(vcol, "_lag3"))) / (get(vcol) + get(paste0(vcol, "_lag3")))] #Ratio asign�ndole m�s peso a la columna nueva
  }
...
if (PARAM$lag1 & PARAM$lag2 & PARAM$lag3) {
  for (vcol in cols_lagueables) {
    dataset[, paste0(vcol, "_TF3_weight") := (get(vcol)*4 + get(paste0(vcol, "_lag1"))*3 + get(paste0(vcol, "_lag2"))*2 + get(paste0(vcol, "_lag3"))*1) / (get(vcol) + get(paste0(vcol, "_lag1")) + get(paste0(vcol, "_lag2")) + get(paste0(vcol, "_lag3")))] #Ratio asign�ndole m�s peso a la columna nueva
    dataset[, paste0(vcol, "_TF3_wavg") := (get(vcol)*4 + get(paste0(vcol, "_lag1"))*3 + get(paste0(vcol, "_lag2"))*2 + get(paste0(vcol, "_lag3"))*1) / 4] #Ratio asign�ndole m�s peso a la columna nueva 
  }
} 

if (PARAM$lag1 & PARAM$lag2)  {
  for (vcol in cols_lagueables) {
    dataset[, paste0(vcol, "_TF2_weight") := (get(vcol)*3 + get(paste0(vcol, "_lag1"))*2 + get(paste0(vcol, "_lag2"))*1 ) / (get(vcol) + get(paste0(vcol, "_lag1")) + get(paste0(vcol, "_lag2")))] #Ratio asign�ndole m�s peso a la columna nueva
    dataset[, paste0(vcol, "_TF2_wavg") := (get(vcol)*3 + get(paste0(vcol, "_lag1"))*2 + get(paste0(vcol, "_lag2"))*1 ) / 4] #Ratio asign�ndole m�s peso a la columna nueva
  }
}
