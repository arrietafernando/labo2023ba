...
#/Users/fernando/Dropbox/MBA/UA - Catedra Labo I/labo_github/buckets/datasets/dataset_pequeno.csv
LABO_PROJ_WD   = setwd(".")
LABO_PROJ_WD   = "/Users/fernando/Library/CloudStorage/Dropbox/MBA/UA - Catedra Labo I/labo_github"
if(ENV == "MAC") {
...
dir.create(paste0(LABO_PROJ_WD, "/tmp"), showWarnings = T)
dir.create(paste0(LABO_PROJ_WD, "/tmp/HT3210"), showWarnings = T)

# Establezco el Working Directory LOCAL del experimento
#setwd("~/exp/HT3210/")
setwd(paste0(LABO_PROJ_WD, "/tmp/HT3210"))
...
dir.create(paste0(LABO_EXP_WD ,"/HT3210/"), showWarnings = FALSE)

# copio los archivos
#system( "cp -r ~/exp/HT3210/*  ~/buckets/b1/exp/HT3210" )
ORIG = paste0("'", gsub(" ", "\\ ", LABO_PROJ_WD), "/tmp/HT3210", "'/*")
DEST = paste0("'", gsub(" ", "\\ ", LABO_EXP_WD), "/HT3210", "'")
system2( r"{cp}", c("-r", ORIG, DEST) )
