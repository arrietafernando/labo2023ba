...
params <- data.frame(vmax_depth  = c(4, 6, 8, 10, 12, 14),
                     vmin_split  = c(1000, 800, 600, 400, 200, 100, 50, 20, 10),
                     vcp         = c(1, 0.5, 0.1, 0.05, 0.01, 0.005)
                    )
                     #vmin_bucket = c(floor(vmin_split/2), floor(vmin_split/4), floor(vmin_split/6), floor(vmin_split/8)),
                     #
